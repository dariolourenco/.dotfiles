...
symlink ~/.dotfiles/config/fish/theme/dariolourenco.fish ~/.config/fish/theme/dariolourenco.fish
...
symlink ~/.dotfiles/config/micro/dariolourenco.micro ~/.config/micro/colorschemes/dariolourenco.micro
